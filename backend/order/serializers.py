...
#         print(f"Vilidated data from serializer{validated_data}")
        
#         order, _ = Order.objects.get_or_create(customer=validated_data['customer'],total=validated_data['total'],status='shipping')
#         print(f"Order detail from serializer{order}")
